...
public class BrokerInterface {
	...
	@Atomic(mode = TxMode.READ)
	public static ClientData getClientDataByNif(String brokerCode, String clientNif) {
		Broker broker = getBrokerByCode(brokerCode);
		if (broker == null) {
			return null;
		}
	...
	public static void createAdventure(String brokerCode, String clientNif, AdventureData adventureData) {
		...
		new Adventure(getBrokerByCode(brokerCode), adventureData.getBegin(), adventureData.getEnd(), client, 0.1);
	}
