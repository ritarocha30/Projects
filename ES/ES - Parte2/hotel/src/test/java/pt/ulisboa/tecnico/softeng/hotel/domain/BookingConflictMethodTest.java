...
public class BookingConflictMethodTest {
	...
	@Before
	public void setUp() {
		Hotel hotel = new Hotel("XPTO123", "Londres", "987654321");
		Room room = new Room(hotel, "01", Room.Type.DOUBLE, 100.00);

		this.booking = new Booking(hotel, room, this.arrival, this.departure, "123456789", "IBAN");
	}
