...
public class BrokerConstructorMethodTest extends RollbackTestAbstractClass {
	...
	@Test
	public void brokerUniqueCode() {
		Broker broker = new Broker(BROKER_CODE, BROKER_NAME, BROKER_NIF_AS_SELLER, NIF_AS_BUYER, BROKER_IBAN);
		Broker broker1 = new Broker("BR22", "XPTO11", "987610561", "189065437", "IBANBR22");
		Assert.assertNotEquals(broker.getCode(), broker1.getCode());
		Assert.assertEquals(2, FenixFramework.getDomainRoot().getBrokerSet().size());
	}
