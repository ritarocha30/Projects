...
public class RoomReserveMethodTest {
	...
	public void cancelReserve() {
		...
		Assert.assertEquals(false, this.room.isFree(Type.SINGLE, this.arrival, this.departure));
		booking.cancel();
		Assert.assertEquals(true, booking.isCancelled());
		Assert.assertEquals(true, this.room.isFree(Type.SINGLE, this.arrival, this.departure));
	}
